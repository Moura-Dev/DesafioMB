        ...
        feiras.append(
            {
                ...
                "coddist": f.coddist,
                "distrito": f.distrito,
                "codsubprefe": f.codsubprefe,
                "subprefe": f.subprefe,
                "regiao5": f.regiao5,
                "regiao8": f.regiao8,
                "nome_feira": f.nome_feira,
                "registro": f.registro,
...
def BuscarPorNomeFeira(cod):
    ...
    consultar = FeirasLivres.query.filter(
        FeirasLivres.nome_feira.like({f"%{cod}%"})
    ).all()
    feiras = []
...
def AdicionarFeira():
    ...
    nova_feira = FeirasLivres(
        long_=new_fr["long_"],
        lat=new_fr["lat"],
        setcens=new_fr["setcens"],
        areap=new_fr["areap"],
        coddist=new_fr["coddist"],
        distrito=new_fr["distrito"],
        codsubprefe=new_fr["codsubprefe"],
        subprefe=new_fr["subprefe"],
        regiao5=new_fr["regiao5"],
        regiao8=new_fr["regiao8"],
        nome_feira=new_fr["nome_feira"],
        registro=new_fr["registro"],
        logradouro=new_fr["logradouro"],
        numero=new_fr["numero"],
        bairro=new_fr["bairro"],
        referencia=new_fr["referencia"],
    )
